...
extension ViewController  {
	...
	func queryCameraAuthorizationStatusAndNotifyUserIfNotGranted() -> Bool {
		let numCameras =  AVCaptureDevice.DiscoverySession.init(deviceTypes: [.builtInWideAngleCamera, .builtInDuoCamera, .builtInTelephotoCamera], mediaType: .video, position: .front).devices
